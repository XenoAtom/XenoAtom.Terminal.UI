...
public sealed record MaskedInputStyle : IStyle<MaskedInputStyle>
{
    public static MaskedInputStyle Default { get; } = new();

    public static StyleKey<MaskedInputStyle> Key { get; } = new("MaskedInputStyle", Default);
