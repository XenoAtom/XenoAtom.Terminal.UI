...
public sealed partial class FigletFont
{
    ...
    [
        FigletPredefinedFont.Banner3D,
        FigletPredefinedFont.Big,
        Block,
        FigletPredefinedFont.Bubble,
        FigletPredefinedFont.BulbHead,
        FigletPredefinedFont.CyberLarge,
        FigletPredefinedFont.CyberMedium,
        FigletPredefinedFont.Digital,
        FigletPredefinedFont.Doh,
        FigletPredefinedFont.Doom,
        FigletPredefinedFont.DotMatrix,
        FigletPredefinedFont.Isometric1,
        FigletPredefinedFont.Isometric2,
        FigletPredefinedFont.Isometric3,
        FigletPredefinedFont.Lcd,
        FigletPredefinedFont.Ogre,
        FigletPredefinedFont.Shadow,
        FigletPredefinedFont.Slant,
        FigletPredefinedFont.Small,
        FigletPredefinedFont.Smslant,
        FigletPredefinedFont.Standard,
        FigletPredefinedFont.ThreeD,
        FigletPredefinedFont.ThreeXFive
    ];
