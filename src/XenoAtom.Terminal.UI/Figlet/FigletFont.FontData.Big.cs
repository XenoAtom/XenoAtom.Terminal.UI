...
{
    /// <summary>
    /// Gets the Big FIGlet font used for rendering text in the FIGlet format. From https://www.figlet.org/fonts/big.flf.
    /// </summary>
    public static FigletFont Big => BigFontHolder.Instance;

    /// <summary>
    /// Hold the Big font instance for lazy initialization and NativeAOT friendliness.
    /// </summary>
    private static class BigFontHolder
    {
        public static readonly FigletFont Instance = Parse(BigFontData, new("Big", "Glenn Chappel", "https://www.figlet.org/fonts/big.flf"));

        // https://www.figlet.org/fonts/big.flf
        private const string BigFontData = """
