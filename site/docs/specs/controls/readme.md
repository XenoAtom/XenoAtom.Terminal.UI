...
This folder contains contributor-facing specs for individual controls.

Each control page in the user documentation links to its corresponding spec file.

> [!TIP]
> Keep specs close to the code. When behavior changes, update the spec in the same PR.
...
- [RadioButtonList](radiobuttonlist.md)
- [Switch](switch.md)
- [Link](link.md)
...
## <i class="bi bi-diagram-3 xenoatom-icon xenoatom-icon--docs" aria-hidden="true"></i> Shared subsystems

- [Menu System](menu-system.md) (MenuBar + context menus)
